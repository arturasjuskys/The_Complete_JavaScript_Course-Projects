...
var renderSpiner = function renderSpiner(parentEl) {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 5:
            ...
            _context.next = 8;
            return fetch("https://forkify-api.herokuapp.com/api/v2/recipes/".concat(id) // 'https://forkify-api.herokuapp.com/api/v2/recipes/5ed6604591c37cdc054bcc40'
            );
